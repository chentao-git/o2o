 ...
 * https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxf3d60ffc3b690add&redirect_uri=http://www.chentao.fun/o2o/wechatlogin/logincheck&role_type=1&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect
...
public class WechatLoginController {
	...
	public String doGet(HttpServletRequest request, HttpServletResponse response) {
		...
		if (auth == null) {
			log.info("微信号第一次关注给其注册微信账号，同时注册用户信息");
